...
def build_primary_toolbar(window, actions: MainWindowActions) -> QToolBar:
    ...
    _add_toolbar_action(toolbar, actions.load_saved_ai, toolbar_text="Load AI", min_width=98)
    _add_toolbar_action(toolbar, actions.open_ai_report, toolbar_text="AI Report", min_width=110)
